...
from schemathesis import Case, DataGenerationMethod, fixups, saas
...
def test_commands_run_help(cli):
    ...
    assert result_help.stdout.strip().split("\n") == [
        ...
        "  --saas-token TEXT               SaaS authentication token. If present, test",
        "                                  run results will be uploaded to",
        "                                  Schemathesis.io",
        "",
        "  --saas-url TEXT                 SaaS base URL.",
