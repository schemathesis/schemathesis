...
@pytest.mark.parametrize(
    "value,type_", [("x", "integer"), (5, "string"), (True, "integer")], ids=["str-int", "int-str", "bool-int"]
)
def test_value_not_matching_declared_type_is_rejected(value, type_):
    assert is_kept(value, type_) is False
