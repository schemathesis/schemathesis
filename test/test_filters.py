...
""".format(
    ...
    result.stdout.re_match_lines([r"test_endpoint_filter.py::test_[GET /foo][P] PASSED"])
...
""".format(
    ...
    result.stdout.re_match_lines(
        [
            r"test_method_filter.py::test_[GET /foo][P] PASSED",
            r"test_method_filter.py::test_[GET /users][P] PASSED",
        ]
    )
...
""",
    ...
    result.stdout.re_match_lines([r"test_tag_filter.py::test_[GET /bar][P] PASSED"])
...
""",
    ...
    result.stdout.re_match_lines([r"test_operation_id_filter.py::test_[GET /bar][P] PASSED"])
...
""",
    ...
    result.stdout.re_match_lines([r"test_operation_id_list_filter.py::test_[GET /foo][P] PASSED"])
    result.stdout.re_match_lines([r"test_operation_id_list_filter.py::test_[POST /foo][P] PASSED"])
