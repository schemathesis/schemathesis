...
@pytest.mark.parametrize(
    ...
    [
        ...
        # The leading `[a-zA-Z0-9]+` consumes the entire length budget when greedy,
        # which would collapse the variable-inner suffix to `{0}`. That collapse
        # rejects values like "abc-def", so we bail and keep the original schema.
