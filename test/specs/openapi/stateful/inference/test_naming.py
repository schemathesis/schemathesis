...
@pytest.mark.parametrize(
    ...
    [
        ...
        # Plural foreign-key arrays (`siteIds`, `site_ids`, …)
        ("siteIds", "/events", "Site"),
        ("userUuids", "/groups", "User"),
        ("orderGuids", "/reports", "Order"),
        ("site_ids", "/events", "Site"),
        ("user_uuids", "/groups", "User"),
        ("session_guids", "/audits", "Session"),
        ("session-guids", "/audits", "Session"),
