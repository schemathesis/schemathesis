...
def test_materialize_inline_schema_yields_resolved_parents(materialize_targets):
...
def test_materialize_bundled_ref_yields_target_dict_as_schema(materialize_targets):
    schema = {
        "$ref": "#/x-bundled/inner",
...
def test_materialize_dag_yields_distinct_targets_pointing_to_same_dict(materialize_targets):
    schema = {
        "type": "object",
        "properties": {
...
def test_materialize_skips_descriptors_when_replay_schema_diverges(materialize_targets):
    ...
    targets = materialize_targets(replay_schema, descriptors)
...
def test_materialize_skips_descriptors_with_missing_bundle_target(materialize_targets):
    ...
    assert materialize_targets(replay_schema, descriptors) == []
