...
def test_extract_top_level(operation):
    ...
    assert extracted == [
        ...
        {"container": "cookies", "name": "SESSION", "value": {"$ref": "#/components/examples/Referenced3"}},
        {"container": "cookies", "name": "SESSION", "value": "cookie3"},
        {"container": "query", "name": "id", "value": "query0"},
        {"container": "query", "name": "id", "value": "query1"},
        {"container": "query", "name": "id", "value": {"$ref": "#/components/examples/Referenced3"}},
        {"container": "query", "name": "Referenced", "value": "Ref-1"},
        {"container": "query", "name": "Referenced", "value": "Ref-2"},
        {"container": "query", "name": "Referenced", "value": {"$ref": "#/components/examples/Referenced3"}},
        ...
        {"media_type": "multipart/form-data", "value": {"$ref": "#/components/examples/Referenced2"}},
    ]
    assert list(examples.produce_combinations(top_level_examples)) == [
        ...
        },
        {
            ...
            "media_type": "application/json",
            "query": {
                "Referenced": {"$ref": "#/components/examples/Referenced3"},
                "id": {"$ref": "#/components/examples/Referenced3"},
            },
        },
        {
            "body": {"foo": "string2"},
            "cookies": {"SESSION": {"$ref": "#/components/examples/Referenced3"}},
            "headers": {"anyKey": "header0"},
            "media_type": "application/json",
            "query": {"Referenced": "Ref-1", "id": "query0"},
        },
        ...
        {
            "body": {"$ref": "#/components/examples/Referenced2"},
            "cookies": {"SESSION": {"$ref": "#/components/examples/Referenced3"}},
            "headers": {"anyKey": "header0"},
            "media_type": "multipart/form-data",
            "query": {"Referenced": "Ref-1", "id": "query0"},
