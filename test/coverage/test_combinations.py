...
@pytest.fixture
def pctx():
    return CoverageContext(location="query", generation_modes=[GenerationMode.POSITIVE])


@pytest.fixture
def nctx():
    return CoverageContext(location="query", generation_modes=[GenerationMode.NEGATIVE])
