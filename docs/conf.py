...
release = version = schemathesis.__version__
...
latex_documents = [(master_doc, "schemathesis.tex", "schemathesis Documentation", "platform team", "manual")]
...
man_pages = [(master_doc, "schemathesis", "schemathesis Documentation", [author], 1)]
