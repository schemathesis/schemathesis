...
!!! note ""
    ...
    **Possible values**: `off`, `missing_auth`, `base_url_mismatch`, `missing_test_data`, `validation_mismatch`, `missing_deserializer`, `unused_openapi_auth`, `unsupported_regex`, `method_not_allowed`, `constants_extraction`, `unmatched_filter`, `unresolvable_reference`, `low_valid_rate`  
...
!!! note ""
    ...
    **Range**: `≥1`  
    ...
    Caps the number of generated test cases. The effect depends on the test phase:
