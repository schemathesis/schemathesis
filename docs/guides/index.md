...
Set up authentication for APIs that require credentials. Covers automatic register/login detection, static tokens, config-based token fetch, dynamic refresh, and endpoint-specific auth strategies.
