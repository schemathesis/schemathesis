...
from ...models import empty_object
from ...protocols import EndpointProtocol


@attr.s(slots=True)  # pragma: no mutate
class BaseSecurityProcessor:
    def process_definitions(self, schema: Dict[str, Any], endpoint: EndpointProtocol, resolver: RefResolver) -> None:
    ...
    def process_api_key_security_definition(self, definition: Dict[str, Any], endpoint: EndpointProtocol) -> None:
    ...
    def process_http_security_definition(self, definition: Dict[str, Any], endpoint: EndpointProtocol) -> None:
...
def get_security_requirements(schema: Dict[str, Any], endpoint: EndpointProtocol) -> List[str]:
