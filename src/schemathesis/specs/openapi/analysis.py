...
class OpenAPIAnalysis:
    ...
    def __init__(self, schema: OpenApiSchema) -> None:
        ...
        self._dependency_layers: list[list[str]] | None | object = NOT_SET
