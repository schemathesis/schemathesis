...
class OpenApiSchema(BaseSchema):
    ...
    def _parse_security(
        ...
        # Security schemes always live at the schema root; resolve their refs from the root resolver
        # rather than a path-scoped one (which would mis-resolve relative file refs).
