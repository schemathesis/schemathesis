...
def get_case_strategy(
    ...
    if body is NOT_SET:
        if operation.body:
            ...
            body_ = ValueContainer(location="body", value=draw(strategy), generator=body_generator)
        else:
            body_ = ValueContainer(location="body", value=body, generator=None)
    else:
...
def generate_parameter(
    ...
    if value == explicit:
        ...
        used_generator = None
    return ValueContainer(location=location, value=value, generator=used_generator)
