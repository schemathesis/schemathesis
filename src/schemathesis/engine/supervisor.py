...
# All-405 streak required before an operation is treated as not implemented.
# A single non-405 anywhere cancels the streak, so two is enough to rule out a one-off.
METHOD_NOT_ALLOWED_THRESHOLD = 2
