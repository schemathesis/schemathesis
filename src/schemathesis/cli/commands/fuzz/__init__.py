"""Continuous fuzzing command for schemathesis."""
...
@grouped_option(
    "--max-time",
    "max_time",
    help="Maximum fuzzing duration in seconds. Fuzzing runs indefinitely if not set",
...
def fuzz(
    ...
    *,
    ...
    generation_maximize: list[MetricFunction] | None = None,
    ...
    **__kwargs: Any,
    ...
    """Run continuous fuzzing against an API schema."""
