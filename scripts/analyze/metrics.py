...
def _attribution_label(recorder_label: str, case_value: dict) -> str:
    # Stateful groups under the synthetic recorder label; fuzz attributes per-case to the
    # real operation; everything else uses the recorder label (the declared operation).
